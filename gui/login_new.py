...
"	")
        ...
        self.main_bg_label.setPixmap(QPixmap(u"assets/images/main_bg.jpg"))
        ...
        self.login_button.setGeometry(QRect(170, 350, 75, 23))
        ...
        self.login_auth_text.setGeometry(QRect(180, 320, 47, 13))
